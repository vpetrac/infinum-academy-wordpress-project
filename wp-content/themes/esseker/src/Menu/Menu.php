 ...
 *
 * @package Esseker\Menu
 */

declare(strict_types=1);

namespace Esseker\Menu;

use EssekerVendor\EightshiftLibs\Menu\AbstractMenu;
...
class Menu extends AbstractMenu
{
	...
	{
		return [
			'header_main_nav' => \esc_html__('Main Menu', 'esseker'),
			'footer_main_nav' => \esc_html__('Footer Menu', 'esseker'),
		];
	}
}
