...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<>
			{!wrapperDisable &&
				<PanelBody title={<span>{__('Layout', 'esseker')}</span>} initialOpen={false} icon={icons.wrapper} className='es-panel-title'>
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<IconToggle
							...
							label={__('Simple wrapper', 'esseker')}
							checked={wrapperUseSimple}
							onChange={(value) => setAttributes({ wrapperUseSimple: value })}
							help={__('Provides only basic spacing and background options.', 'esseker')}
						/>
					}
					...
					{wrapperUse &&
						<>
							...
							{showWrapperSpacingTop &&
								<Responsive label={<IconLabel icon={icons.spacingTop} label={__('Top spacing', 'esseker')} />}>
							...
							{showWrapperSpacingBottom &&
								<Responsive label={<IconLabel icon={icons.spacingBottom} label={__('Bottom spacing', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingTopIn &&
								<Responsive label={<IconLabel icon={icons.spacingTopIn} label={__('Top inner spacing', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingBottomIn &&
								<Responsive label={<IconLabel icon={icons.spacingBottomIn} label={__('Bottom inner spacing', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerTop &&
								<Responsive label={<IconLabel icon={icons.dividerTop} label={__('Top divider', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerBottom &&
								<Responsive label={<IconLabel icon={icons.dividerBottom} label={__('Bottom divider', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperHide &&
								<Responsive label={<IconLabel icon={icons.hide} label={__('Hide', 'esseker')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperBackgroundColor &&
								<ColorPaletteCustom
									label={<IconLabel icon={icons.backgroundTypeAlt} label={__('Background color', 'esseker')} />}
							...
							{!wrapperUseSimple &&
								<>
									{showWrapperWidth &&
										<Responsive label={<IconLabel icon={icons.width} label={__('Width', 'esseker')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperOffset &&
										<Responsive label={<IconLabel icon={icons.offset} label={__('Offset', 'esseker')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperContainerWidth &&
										<Responsive label={<IconLabel icon={icons.containerWidth} label={__('Container width', 'esseker')} />}>
											{options.breakpoints.map((item, index) => {
												const point = ucfirst(item);
									...
									{showWrapperGutter &&
										<Responsive label={<IconLabel icon={icons.gutter} label={__('Gutter', 'esseker')} />}>
											{options.breakpoints.map((item, index) => {
							...
							{showWrapperAnchorId &&
								<TextControl
									label={<IconLabel icon={icons.anchor} label={__('Block anchor ID', 'esseker')} />}
							...
							{showWrapperId &&
								<TextControl
									label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'esseker')} />}
									value={wrapperId}
