...
/**
 * File that holds class for EventPostType custom post type registration.
 *
 * @package Esseker\CustomPostType
 */

declare(strict_types=1);

namespace Esseker\CustomPostType;

use EssekerVendor\EightshiftLibs\CustomPostType\AbstractPostType;
...
class EventPostType extends AbstractPostType
{
	 ...
	 * @var string
	 */
	public const POST_TYPE_SLUG = 'event';
	 ...
	 * @var string
	 */
	public const POST_TYPE_URL_SLUG = 'event';
	 ...
	 * @var string
	 */
	public const REST_API_ENDPOINT_SLUG = 'events';
